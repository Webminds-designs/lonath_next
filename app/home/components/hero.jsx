...
export default function Hero() {
    ...
    // Set default animation progress for server-side rendering
    const [animationProgress, setAnimationProgress] = useState([0, 0.1, 0.2, 1])

    useEffect(() => {
        // Update isMobile and animationProgress when client-side
        const checkMobile = () => {
            const mobile = window.innerWidth < 768
            setIsMobile(mobile)
            setAnimationProgress(mobile ? [0, 0.15, 0.3, 1] : [0, 0.1, 0.2, 1])
        }
        ...
        <div ref={containerRef} className='flex flex-col space-y-5 px-12 w-full max-w-[1920px] mx-auto pb-10 md:pb-14 lg:pb-20 xl:pb-24 2xl:pb-32'>
            ...
            <motion.div
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `url(${'/images/selfie.webp'})`,
