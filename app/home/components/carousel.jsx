...
export default function Carousel() {
  ...
  // Items to display
  const items = [
    { id: 1, image: '/images/photoshop.webp', name: 'Photoshop' },
    { id: 2, image: '/images/illustrator.webp', name: 'Illustrator' },
    { id: 3, image: '/images/figma.webp', name: 'Figma' },
    { id: 4, image: '/images/premiere-pro.webp', name: 'Premiere Pro' },
  ];
