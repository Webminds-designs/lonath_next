...
export default function Carousel() {
  ...
  // Items to display
  const items = [
    { id: 1, image: '/images/photoshop.png', name: 'Photoshop' },
    { id: 2, image: '/images/illustrator.png', name: 'Illustrator' },
    { id: 3, image: '/images/figma.png', name: 'Figma' },
    { id: 4, image: '/images/premiere-pro.png', name: 'Premiere Pro' },
  ];
